defmodule SocialScribeWeb.MeetingLive.ShowTest do
  ...
  describe "HubSpot Contact Update Modal" do
    ...
    test "shows message when no HubSpot credential is connected", %{
      conn: conn,
      meeting: meeting,
    ...
    test "shows Review Update button when credential and contact info exist", %{
      conn: conn,
      meeting: meeting,
      user: user,
      meeting_transcript: meeting_transcript
    ...
    test "searching contacts with empty query clears results", %{
      conn: conn,
      meeting: meeting,
      user: user,
      meeting_transcript: meeting_transcript
    ...
    test "displays extracted contact information in modal", %{
      conn: conn,
      meeting: meeting,
      user: user,
      meeting_transcript: meeting_transcript
    ...
    test "update button is disabled when no contact selected", %{
      conn: conn,
      meeting: meeting,
      user: user,
      meeting_transcript: meeting_transcript
    ...
    test "shows waiting message when contact info is being extracted", %{
      conn: conn,
      meeting: meeting,
      user: user
    } do
    ...
    test "shows no contact info message when none found", %{
      conn: conn,
      meeting: meeting,
      user: user,
      meeting_transcript: meeting_transcript
